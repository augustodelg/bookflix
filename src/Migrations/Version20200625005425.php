 ...
 */
final class Version20200625005425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuenta ADD perfil_activo INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuenta DROP perfil_activo');
    }
}
