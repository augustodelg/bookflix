 ...
 */
final class Version20200505190358 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuenta ADD CONSTRAINT FK_31C7BFCFD8720997 FOREIGN KEY (tarjeta_id) REFERENCES tarjeta (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
