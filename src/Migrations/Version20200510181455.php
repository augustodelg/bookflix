 ...
 */
final class Version20200510181455 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuenta ADD tarjeta_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cuenta ADD CONSTRAINT FK_31C7BFCFF1D4C0C4 FOREIGN KEY (tarjeta_id_id) REFERENCES tarjeta (id)');
        $this->addSql('CREATE INDEX IDX_31C7BFCFF1D4C0C4 ON cuenta (tarjeta_id_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuenta DROP FOREIGN KEY FK_31C7BFCFF1D4C0C4');
        $this->addSql('DROP INDEX IDX_31C7BFCFF1D4C0C4 ON cuenta');
        $this->addSql('ALTER TABLE cuenta DROP tarjeta_id_id');
